            ...
            <div className="w-full max-w-[440px] animate-pop-in">
                ...
                <div className="bg-wink-white rounded-[2.5rem] p-10 lg:p-12 shadow-2xl">
                    <div className="mb-10 text-center">
                        <h1 className="text-3xl font-black text-wink-black uppercase tracking-tighter mb-2">Welcome Back</h1>
                        <p className="text-wink-gray-400 font-medium text-sm tracking-tight">Access your automation workspace.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        >
                            {isSubmitting ? <Loader2 size={20} className="animate-spin" /> : <span>Initialize Access</span>}
                            {!isSubmitting && <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />}
                        </button>
                    </form>

                    <div className="mt-12 text-center pt-8 border-t border-wink-gray-50">
                        <p className="text-wink-gray-400 text-[10px] font-black uppercase tracking-widest mb-4">No workspace yet?</p>
                        <button
